...
var activityTypeArray = [
    ActivityType(id: 1, name: "DaBian", imageName: "activity_1.jpg"),
    ActivityType(id: 2, name: "XiaoBian", imageName: "activity_2.jpg"),
    ActivityType(id: 3, name: "ShuiJiao", imageName: "activity_3.jpg"),
    ActivityType(id: 4, name: "WuShui", imageName: "activity_4.jpg"),
    ActivityType(id: 5, name: "ChiFan", imageName: "activity_5.jpg"),
    ActivityType(id: 6, name: "LingShi", imageName: "activity_6.jpg"),
    ActivityType(id: 7, name: "ShiNeiGeRenHuoDong", imageName: "activity_7.jpg"),
    ActivityType(id: 8, name: "ShiNeiJiTiHuoDong", imageName: "activity_8.jpg"),
    ActivityType(id: 9, name: "ShiWaiGeRenHuoDong", imageName: "activity_9.jpg"),
    ActivityType(id: 10, name: "ShiWaiJiTiHuoDong", imageName: "activity_10.jpg"),
    ActivityType(id: 11, name: "XiSu", imageName: "activity_11.jpg"),
    ActivityType(id: 12, name: "QiTa", imageName: "activity_12.jpg"),
    ActivityType(id: 13, name: "QiChuang", imageName: "activity_13.jpg"),
    ActivityType(id: 14, name: "XiZao", imageName: "activity_14.jpg"),
    ActivityType(id: 15, name: "ShengBing", imageName: "activity_15.jpg"),
    ActivityType(id: 20, name: "DaoXiao", imageName: "activity_20.jpg"),
    ActivityType(id: 30, name: "LiXiao", imageName: "activity_30.jpg"),
]
